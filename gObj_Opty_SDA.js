...
const objectName = "Opty_Sda__c"; // Updated object name
...
<CustomObject xmlns="http://soap.sforce.com/2006/04/metadata">
    <label>Opty Sda</label>
    <pluralLabel>Opty Sdas</pluralLabel>
    <nameField>
        <type>AutoNumber</type>
        <label>Opty Sda Number</label>
...
const fields = [
    ...
    { name: "Amount1__c", label: "Amount1", type: "Currency", scale: 2, precision: 16 },
    { name: "Amount2__c", label: "Amount2", type: "Currency", scale: 2, precision: 16 },
    ...
    { 
        ...
        relationshipName: "OptySda_Opportunity" // Fixed: Added required relationshipName
    },
    { 
...
<CustomField xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    const tabsFolder = path.join("force-app", "main", "default", "tabs");
